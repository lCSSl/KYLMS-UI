  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="WmsStowageMdWaybillList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" fixed label="序号" type="index" width="60"/>
              <el-table-column label="线路ID" show-overflow-tooltip width="150" align="center" prop="routeId" >
...
<script>
import { listWmsStowageMdWaybill, getWmsStowageMdWaybill, delWmsStowageMdWaybill, addWmsStowageMdWaybill, updateWmsStowageMdWaybill } from "@/api/wms/WmsStowageMdWaybill";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listWmsStowageMdWaybill(this.queryParams).then(response => {
